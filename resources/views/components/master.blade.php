...
<script src="{{ asset('assets/admin/') }}/js/pie-chart.js" type="text/javascript"></script>
...
<!-- //pie-chart --><!-- index page sales reviews visitors pie chart -->
	...
	<!-- requried-jsfiles-for owl -->
					<link href="{{ asset('assets/admin/') }}/css/owl.carousel.css" rel="stylesheet">
...
<x-partials.footer/>
    ...
    <script src="{{ asset('assets/admin/') }}/js/Chart.bundle.js"></script>
	...
	<script src="{{ asset('assets/admin/') }}/js/SimpleChart.js"></script>
    <script>
        var graphdata1 = {
            linecolor: "#CCA300",
            title: "Monday",
